...
We permit users to re-distribute official builds as-is **without modification**, however we would prefer if you linked to https://www.duckstation.org/ instead. We **do not** permit users to distribute pre-configured releases of DuckStation.
